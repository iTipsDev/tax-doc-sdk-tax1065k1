# tax-doc-sdk-tax1065k1

Software development kit to generate IRS Form 1065 K-1 as PDF file using Financial Data Exchange (FDX) standards including QR codes and embedded JSON.

<img alt="Sample Form" src="samples/Tax1065K1.sample.png" width="850"/>
