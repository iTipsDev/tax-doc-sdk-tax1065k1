package org.taxdataexchange.usage.tax1065k1;

import org.taxdataexchange.core.utils.*;
import org.taxdataexchange.docs.tax1065k1.models.*;
import org.taxdataexchange.docs.tax1065k1.utils.*;

public class Tax1065K1DocumentGenerator {
    ...
    public static TaxDataList sampleData( ) {
        ...
        // Sample data
        // -----------------------------------------------------------------
        TaxData taxData = SampleData.sampleTaxData( "Tax1065K1" );
    ...
    public static byte[] sampleQrAsPng( ) {
        ...
        Tax1065K1PdfBuilder pdfBuilder = new Tax1065K1PdfBuilder( );
        byte[] bytes = pdfBuilder.buildQr( taxDataList );

        String filePath = "samples/Tax1065K1.qr.png";
    ...
    public static void samplePdf( ) {
        ...
        String filePath = "samples/Tax1065K1.sample.pdf";
        FileUtils.bytesToFile( pdfBytes, filePath );
        System.out.println( filePath );

        String filePathPng = "samples/Tax1065K1.sample.png";
    ...
    public static void addCoverPage() {
        ...
        String filePath2 = "samples/Tax1065K1.cover.pdf";
        FileUtils.bytesToFile( combinedBytes, filePath2 );
    ...
    public static void insertQrCode() {
        ...
        String filePath2 = "samples/Tax1065K1.inserted.pdf";
        FileUtils.bytesToFile( combinedBytes, filePath2 );
    ...
    public static void main(String[] args) {
        ...
        System.out.println( "Tax1065K1DocumentGenerator Begin" );
        ...
        System.out.println( "Tax1065K1DocumentGenerator Done" );
