...
import irs.fdxtax640.jsonserializers.Tax1065K1Serializer;
import irs.fdxtax640.jsonserializers.TaxStatementListSerializer;
import irs.fdxtax640.map2objects.Map2Tax1065K1;
import irs.fdxtax640.obj2mappers.TaxStatementList2Map;

import org.apache.commons.lang3.time.StopWatch;
import org.taxdataexchange.core.pdfbuilders.Tax1065K1PdfBuilder;
...
public class Tax1065K1DocumentGenerator {
    ...
    private void processOneRow(
        ...
        Tax1065K1 obj = Map2Tax1065K1.generate( row );
        {
            String asJson = Tax1065K1Serializer.serialize( obj );
    ...
    private void processCsvForCompany(
        ...
        // CSV file
        String csvFileName  = "Tax1065K1.csv";
        ...
        String outputFileName = "Tax1065K1.rows.json";
    ...
    public static void main(String[] args) {
        ...
        Tax1065K1DocumentGenerator generator = new Tax1065K1DocumentGenerator( );
